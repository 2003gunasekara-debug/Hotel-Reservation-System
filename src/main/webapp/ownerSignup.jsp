...
<html>
<head>
  <title>Owner Signup - HotelSync</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
  <div class="container-fluid">
    ...
    <div class="navbar-nav ms-auto">
      <a class="nav-link" href="${pageContext.request.contextPath}/index.jsp"><i class="fas fa-home"></i> Back to Dashboard</a>
    </div>
  </div>
</nav>
...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/OwnerSignupServlet" method="post" id="signupForm" novalidate>
    <div class="row mb-3">
      <div class="col-md-6">
    ...
    <div class="row mt-4">
      <div class="col-md-6">
        <button type="submit" class="btn btn-primary w-100"><i class="fas fa-user-plus"></i> Register Owner</button>
      </div>
    </div>
  </form>
</div>
