...
<html>
<head>
    <title>Owner Profile - HotelSync</title>
...
<div class="container">
    ...
    <div class="col-md-6">
        <form action="${pageContext.request.contextPath}/DeleteAccountServlet" method="post" onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be undone.');">
