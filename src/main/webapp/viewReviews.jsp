...
<html>
<head>
  <title>Hotel Reviews - HotelSync</title>
...
<div class="container">
  ...
  <c:choose>
    <c:when test="${empty reviews}">
      <p class="text-muted">No reviews available for this hotel.</p>
    </c:when>
    <c:otherwise>
          ...
          <div class="col">
            <div class="review-card card h-100">
              ...
              <img src="${pageContext.request.contextPath}/${defaultPath}?t=${System.currentTimeMillis()}"
                   alt="${r.touristName} Review Image"
                   class="card-img-top"
              ...
              <div class="card-body">
                <h5 class="card-title">Review by: <c:out value="${r.touristName != null ? r.touristName : 'Anonymous'}" /></h5>
                <div class="rating">
