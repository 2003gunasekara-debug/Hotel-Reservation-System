...
<html>
<head>
    <title>Add Review - HotelSync</title>
...
<div class="container">
    <div class="welcome-message">
        <h2>Add Review</h2>
        <p>Share your experience with the hotel</p>
    </div>
    ...
    <form action="AddReviewServlet" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="description" class="form-control" rows="5" placeholder="Write your review here" required></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Submit Review</button>
            <a href="ViewBookingsServlet" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Bookings</a>
        </div>
    </form>
</div>
